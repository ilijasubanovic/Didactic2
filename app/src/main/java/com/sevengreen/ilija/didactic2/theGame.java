...
//		Log.v("onRestart", "Tick of Progress onRestart 2  "+timerActive);
    ...
    public void initializeNewLevel () {
        ...
        if(level.getLevelNumber()%3==0 && lives<4 && level.getLevelNumber()>1)
        {
...
//        		resumeLevel(level);
        ...
        ImageView display = (ImageView) findViewById(R.id.ImageView04);
        //main image has same image as i1 image container
        //display main image
        display.setImageResource(getBaseContext().getResources().getIdentifier("i1_"+indexOfImageContent[1],"drawable","com.sevengreen.ilija.didactic2"));
    ...
    public void generateImageContentIndexes () {
        ...
        else
        {
            ...
            {
                do{
                    indexOfImageContent[3] = r.nextInt(8 - 1) + 1;
    ...
    public void setImageToView (final ImageChoice i) {
        ...
        choiceX = (ImageView) findViewById(getBaseContext().getResources().getIdentifier(imageResource,"id","com.sevengreen.ilija.didactic2"));
        choiceX.setImageResource(getBaseContext().getResources().getIdentifier(i.getImageResource(),"drawable","com.sevengreen.ilija.didactic2"));
        ...
        if(i.getIsCorrectAnswer() && level.getLevelNumber()==1)
        {
            ...
            //layers[0] = r.getDrawable(getBaseContext().getResources().getIdentifier(i.getImageResource(),"drawable","com.sevengreen.ilija.didactic2"));
            //layers[1] = r.getDrawable(R.drawable.hand_point_white);
            layers[0] = ContextCompat.getDrawable(getApplicationContext().getApplicationContext(),getBaseContext().getResources().getIdentifier(i.getImageResource(),"drawable","com.sevengreen.ilija.didactic2"));
            //r.getDrawable(getBaseContext().getResources().getIdentifier(i.getImageResource(),"drawable","com.sevengreen.ilija.didactic2"));
    ...
    public void answerCorrect () {
        ...
        result.setImageResource(getBaseContext().getResources().getIdentifier("correct","drawable","com.sevengreen.ilija.didactic2"));
        //set opacity of mark
    ...
    public void answerWrong () {
        ...
        result.setImageResource(getBaseContext().getResources().getIdentifier("wrong","drawable","com.sevengreen.ilija.didactic2"));
        //set opacity of mark
        resultImageAlpha = 250;
        if(!level.getLevelBonus())
            removeLife();
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        {
                            if((elapsed/200)%2==1)
                                choiceX.setImageResource(getBaseContext().getResources().getIdentifier(i1.getImageResource(),"drawable","com.sevengreen.ilija.didactic2"));
                            if((elapsed/200)%2==0)
